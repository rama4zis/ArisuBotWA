...
var badwords = require("indonesian-badwords");
...
var MessageChecker = require('./handler/messageChecker');
client.on('message', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(msg) {
    var resut, media, random, reply, _media, media2, media3, media4;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          resut = new MessageChecker(client, msg);
          resut.checkMessage();
        ...
        case 12:
          ...
          reply = "";
          _context2.t0 = random;
          _context2.next = _context2.t0 === 0 ? 18 : _context2.t0 === 1 ? 23 : _context2.t0 === 2 ? 28 : _context2.t0 === 3 ? 33 : 38;
          break;
        case 18:
          reply = "Arisu juga pengen kopi Sensei, belikan Arisu kopi dong...";
          client.sendMessage(msg.from, reply);
          _media = MessageMedia.fromFilePath('./assets/sound/Arisu_Cafe_Act_2.mp3');
          client.sendMessage(msg.from, _media, {
        ...
        case 23:
          ...
          client.sendMessage(msg.from, reply);
          media2 = MessageMedia.fromFilePath('./assets/sound/Arisu_Cafe_Act_3.mp3');
        ...
        case 28:
          ...
          client.sendMessage(msg.from, reply);
          media3 = MessageMedia.fromFilePath('./assets/sound/Arisu_Cafe_Act_5.mp3');
        ...
        case 33:
          ...
          client.sendMessage(msg.from, reply);
          media4 = MessageMedia.fromFilePath('./assets/sound/Arisu_Lobby_2.mp3');
